...
\subsection{Grafen jako supravodič}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
...
\subsection{Redukovaný grafenoxid}
\frame{
	\frametitle{}
	\begin{columns}
		\begin{column}{0.5\textwidth}
