...
\frame{
	...
	\vfill
	\begin{itemize}
	\item Materiálová chemie se zabývá syntézou a optimalizací syntézy materiálů, jejich vlastnostmi a charakterizací.
	\item Mimo samotné syntézy sem patří i výpočtová chemie.
	\end{itemize}
	\begin{center}
	\adjincludegraphics[height=4.5cm]{img/Materials_science_tetrahedron.png}
	\end{center}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.55\textheight]{img/Eight_Allotropes_of_Carbon.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=0.32\textwidth]{img/Flexed_plastic_display.jpg}
	\end{figure}
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.85\textheight]{img/Eight_Allotropes_of_Carbon.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\begin{figure}
				\adjincludegraphics[width=0.9\textwidth]{img/Graphen.jpg}
				\adjincludegraphics[width=0.9\textwidth]{img/Graphene.jpg}
			\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Kvalitní vrstvy lze připravit pomocí metody \hyperlink{CVD}{\underline{CVD}} (Chemical Vapor Deposition).
	\end{itemize}
	\begin{figure}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Graphane.png}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				...
				\item Hummerova metoda -- oxidace grafitu pomocí směsi \mbox{\ce{H2SO4 + KMnO4}} a následná exfoliace ultrazvukem.
		...
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=0.9\textwidth]{img/Graphite_oxide.png}
				\adjincludegraphics[width=0.5\textwidth]{img/Graphenoxid_Freezedried_Suspension.jpg}
			\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.4\textwidth}
			\adjincludegraphics[height=.5\textheight]{img/Silicene-Ag_STM5_crop.jpg}
		\end{column}
		\begin{column}{.4\textwidth}
			\adjincludegraphics[height=.5\textheight]{img/Silicene_buckling.png}
		\end{column}
	\end{columns}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.8\textheight]{img/Phosphorene_structure.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[height=.45\textheight]{img/Atomic_force_microscope_block_diagram.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Podle skupenství reaktantů rozlišujeme \textit{homogenní} a \textit{heterogenní} reakce.
		\item \ce{2 H2(g) + O2(g) -> 2 H2O(g)}
		\item \ce{2 NaOH(aq) + H2SO4(aq) -> Na2SO4(aq) + 2 H2O(l)}
		\item \ce{NaOH(aq) + CO2(g) -> NaHCO3(aq)}
		\item \ce{Bi2O3(s) + 3 H2(g) -> 2 Bi(s) + 3 H2O}
		\item \ce{Zn(s) + 2 HCl(aq) -> ZnCl2(aq) + H2(g)}
		\item \ce{WO3(s) + NiO(s) -> NiWO4(s)}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
	\adjincludegraphics[width=0.6\textwidth]{img/Diffusion.png}
	\end{center}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=\textwidth]{img/Chemical_reactions.png}
	\end{center}
	\vfill
}
...
\frame{
	...
	\end{tabular}
	\begin{center}
	\adjincludegraphics[height=3cm]{img/Ammonia_dimensions.png}
	\adjincludegraphics[height=3cm]{img/Gas_cylinder_ammonia.jpg}
	\adjincludegraphics[height=3cm]{img/Hazmatspotting_UN_1005,__Ammonia,_anhydrous_.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/DLR_autoclave_transport_on_A26_high-way.jpg}
		\caption*{Převoz autoklávu}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[height=4cm]{img/Horno_tubular.jpg}
		\adjincludegraphics[height=4cm]{img/Industrial_furnace.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{center}
		\adjincludegraphics[width=0.9\textwidth]{img/Sol-Gel_Technology_Scheme.png}
	\end{center}
	\vfill
}

\subsection{Hydrolytická sol--gelová syntéza}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
...
\frame{
	...
	\vfill
	\begin{center}
		\adjincludegraphics[width=0.8\textwidth]{img/solgel-scheme2.png}
		\footnote[frame]{Feinle, A.; Elsaesser, M.S.; Hüsing, N.
			\emph{Chem. Soc. Rev.}
			2016, 45, 3371-3382}
	\end{center}
	\vfill
...
\frame{
	\frametitle{}
	\vfill
	\adjincludegraphics[height=6cm]{img/SolGel4.png}
	\adjincludegraphics[height=6cm]{img/Aerogel_crayons.jpg}
	\vfill
}

\subsection{Nehydrolytická sol--gelová syntéza}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
...
\frame{
	...
	\vfill
	\begin{center}
		\adjincludegraphics[height=.8\textheight]{img/Glovebox.jpg}
	\end{center}
	\vfil
}
...
\frame{
	...
	\vfill
	\begin{center}
		\adjincludegraphics[height=.8\textheight]{img/Schlenk-line.png}
	\end{center}
	\vfill
}

\subsection{Příprava polymerního křemičitanu -- laboratorní cvičení}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
		\item Hydrolýza TEOSu je ideální příklad sol-gelové syntézy, který lze provést i ve školní laboratoři.\footnote[frame]{\href{https://doi.org/10.1021/ed071p599}{The Sol-Gel Preparation of Silica Gels}}
		\item Chemikálie
		\begin{itemize}
			\item TEOS - tetraethoxysilan (CAS: 78-10-4), cena cca 1000 Kč/l
			\item Ethanol
			\item Destilovaná voda
			\item Kyselina chlorovodíková
		\end{itemize}
		\item Laboratorní vybavení
		\begin{itemize}
			\item Kádinky
			\item Míchačka s ohřevem
		\end{itemize}
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=0.7\textwidth]{img/TEOS-acid-hydrolysis.png}
	\end{center}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{enumerate}
		\item Do 250 ml kádinky vložíme míchadlo a odměříme 30 ml TEOSu.
		\item Přilijeme 30 ml ethanolu a spustíme míchání.
		\item Přidáme 38 ml destilované vody s přídavkem 3-4 kapek koncentrované HCl.
		\item Zkontrolujeme pH roztoku, pokud je vyšší než 3, přidáme kapku HCl.
		\item Reakční směs zahříváme na 60 °C a intenzivně mícháme, dokud nezmizí rozhraní mezi kapalinami.
		\item Po asi 20 minutách vyjmeme míchadlo a zvýšíme teplotu ohřevu na 100 °C.
		\item Zahříváme dokud se nevytvoří gel.
	\end{enumerate}
	\begin{center}
		\adjincludegraphics[width=0.8\textwidth]{img/TEOS-hydrolysis.jpg}
	\end{center}
	\vfill
}

\section{Mechanochemie}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=0.8\textwidth]{img/Sonoluminescence-acoustics.png}
	\end{center}
	\vfill
}
...
\subsection{Sonochemické reakce}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\vfill
			\begin{center}
				\adjincludegraphics[width=\textwidth]{img/Thermite_experiment_01.jpg}
			\end{center}
			\vfill
		\end{column}
	\end{columns}
...
\frame{
	\frametitle{}
			...
			\end{itemize}
			\begin{center}
				\adjincludegraphics[width=0.8\textwidth]{img/CTAB.png}
...
\frame{
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \ce{CH_4 -> C + 2 H_2}
			\item \ce{WF_6 + 3 H_2 -> W + 6 HF}
			\item \ce{SiH_4 + O_2 -> SiO_2 + 2 H_2}
		\end{itemize}
	\end{itemize}
	\adjincludegraphics[height=35mm, center]{img/CVD_Reaction_Chamber.jpg}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item \href{https://is.muni.cz/www/moravec/c5965_vybrane_analyticke_metody_v_chemii_konzervovani-restaurovani/}{\underline{Termická analýza}}
		\item Mikroskopie
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\includegraphics[keepaspectratio,width=5cm]{img/NMR-pulse.png}
	\end{center}
	\vfill
}

\subsubsection{Konstrukce NMR spektrometru}
\frame{
	\frametitle{}
	\vfill
...
\frame{
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\begin{textblock*}{4cm}(7cm,5cm)
		\includegraphics[keepaspectratio,width=4cm]{img/NMR-probe-scheme.png}
	\end{textblock*}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\adjincludegraphics[width=.8\textwidth]{img/RepairMain5.jpg}
		\end{column}
		\begin{column}{.5\textwidth}
			\adjincludegraphics[width=.8\textwidth]{img/bb_vs_ibb.jpg}
		\end{column}
	\end{columns}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.3\textwidth}
			\includegraphics[keepaspectratio,width=3.5cm]{img/decoupling.jpg}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\includegraphics[keepaspectratio,height=5cm]{img/NMR-2D-3D.png}
	\end{center}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\includegraphics[keepaspectratio,height=4cm]{img/NMR-MAS-angle.png}
		\includegraphics[keepaspectratio,height=4cm]{img/NMR-MAS-rotors.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Rychlost a stabilita rotace ovlivňují pološířku píků.\footnote[frame]{\href{http://u-of-o-nmr-facility.blogspot.com/2007/11/magic-angle-spinning.html}{Magic Angle Spinning}}
		\item Rotace způsobuje vznik \textit{rotačních píků}.
	\end{itemize}
	\begin{center}
		\includegraphics[height=.6\textheight]{img/MAS.jpg}
	\end{center}
	\vfill
}

\subsubsection{NMR ve slabém magnetickém poli}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[keepaspectratio,width=0.2\textwidth]{img/Geodynamo_Between_Reversals.png}
		\includegraphics[keepaspectratio,width=0.5\textwidth]{img/HighFieldTAGComparison_cropped.png}
	\end{center}
	\vfill
}

\subsubsection{Využití NMR}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[keepaspectratio,width=0.3\textwidth]{img/H-NMR_1,2-dichlorobenzene.png}
		\includegraphics[keepaspectratio,width=0.3\textwidth]{img/HSQC.png}
		\includegraphics[keepaspectratio,width=0.3\textwidth]{img/Portable-NMR.jpg}
	\end{center}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				...
				\item Měření trvá hodiny až dny.
				\item Měření probíhá při teplotě varu daného plynu.
			\end{itemize}
			\begin{tabular}{|l|l|}
				\hline
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{itemize}
				\item Byla vynalezena roku 1958 Dr. W.Beckerem.
		...
		\begin{column}{.5\textwidth}
			\begin{center}
				\adjincludegraphics[height=.8\textheight]{img/Cut_through_turbomolecular_pump.jpg}
			\end{center}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.6\textwidth}
			\begin{itemize}
				\item Vyžaduje předřazenou vývěvu pro vytvoření dostatečného vakua pro start.
		...
		\begin{column}{.4\textwidth}
			\begin{center}
				...
				\adjincludegraphics[height=.25\textheight]{img/Magneticbearings.jpg}
			\end{center}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Syntéza mezoporézního materiálu MCM-41}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=.9\textwidth]{img/Adsorption_of_Gases_in_Multimolecular_Layers.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\end{itemize}
		\item EDX -- energiově dispezní RTG spektroskopie (Energy-dispersive X-ray spectroscopy). Analytická technika poskytující prvkové složení vzorku.
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Germanium_Telluride_nanowires.jpg}
		\caption*{Nanovlákna GeTe}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Quasimodopsis_riedeli_SEM.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/EDS_-_Rimicaris_exoculata.png}
		\caption*{Ukázka EDX spektra}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.75\textheight]{img/TEM_philips_EM_430.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.3\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.75\textheight]{img/Electron_microscope.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		...
		\caption*{TEM snímek hybridní siliky}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/AFMsetup.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/AFM_-_detail.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.7\textheight]{img/AFM_3D_Topography.jpg}
		\caption*{AFM snímek nanočástic palladia}
	\end{figure}
	\vfill
}
